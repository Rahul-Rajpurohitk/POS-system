...
import stockAdjustmentsRoutes from './stock-adjustments.routes';
import productActivityRoutes from './product-activity.routes';
...
router.use('/product-activities', productActivityRoutes);
